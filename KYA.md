...
Below there is a KYA (Know Your Assumptions) template 
to be displayed on every UI of our projects. 

The KYA should be displayed as a modal the first time a user uses the UI and 
whenever the user clicks the "KYA" link the footer of the UI. 

A good example of KYA display can be seen here:
* https://ergo.bene.stability.nexus
...
The source code of the smart contracts and of the website can be found in [https://github.com/StabilityNexus](https://github.com/StabilityNexus). 
...
* The algortihms and protocols implemented by the code may have unforeseen behaviors.
...
on external infrastucture, you use the applications at your own risk. You are solely responsible for your assets. You are solely responsible for the security of your wallet (and its password, recovery pharse and private keys).
